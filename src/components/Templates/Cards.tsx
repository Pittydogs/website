      ...
      <div className="mt-50 flex w-full flex-col gap-40 md:flex-row">
        <aside className="min-w-[220px]">
          <Text
            as="p"
            style="l"
            className="w-full border-b-1 border-b-neutral-6 pb-10 pr-20 !text-[14px] font-bold text-neutral-12 lg:!text-[18px]"
          >
            Filter By
          </Text>

          <Accordion
            headerClassName="min-h-35 text-[12px] md:text-[16px]"
            items={[
              {
                label: 'Frameworks',
                  ...
                  <Checkbox
                    ...
                    labelElement={
                      <div className="flex flex-row items-center justify-center">
                        <img
                          className="mx-10 inline-block h-16 w-16 rounded-full bg-neutral-6 lg:h-20 lg:w-20"
              ...
              },
              {
                ...
                contentElements: categories.map((category, index) => (
                  <Checkbox
                    ...
                    labelElement={
                      <div className="flex flex-row items-center justify-center">
                        <span className="ml-10 text-[12px] lg:text-[14px]">
                          {category.name}
                        </span>
                        <span className="ml-10 h-16 w-16 rounded-full bg-neutral-4 text-center text-[10px] leading-16 lg:h-20 lg:w-20 lg:leading-20">
                          {category.amount}
